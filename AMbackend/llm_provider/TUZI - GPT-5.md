...
paths:
  /v1/chat/completions:
    post:
                                ...
                                type:
                                  ...
                                  x-apifox-enum:
                                    - value: text
                                      ...
                                      description: ''
                                    - value: image_url
                                      name: 图片，文件链接或者 base64
                                      description: 图片或者文件统一都走该字段传递
                                  description: 只是消息的内容是图片还是文本
                                  title: 消息类型
                                text:
                                  type: string
                                  description: 文本内容
      ...
      security:
        - bearer: []
      x-apifox-folder: openai/聊天（Chat）
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/7040782/apis/api-343647063-run
components:
  schemas: {}
  securitySchemes:
    bearer:
