...
async def execute_trade(
    ...
    async with async_session() as db:
        try:
            ...
            print(f"\n📊 投资组合: {portfolio.name} ({portfolio.instance_name})")
            ...
            trade = Trade(
                ...
                reason="手动交易 - 用户指定以 $102,112.48 买入 $10,000 BTC",
            ...
            print(f"   平均成本: ${holding.avg_buy_price:,.2f} USDT/BTC")
...
if __name__ == "__main__":
    portfolio_id = "867ca89a-2100-401a-bf31-8fcb6862f1ee"  # BTC长持+波动策略
    price = 102112.48  # BTC价格
    usdt_amount = 10000.0  # 购买金额

    print(f"🚀 开始执行手动交易...")
    print(f"   策略实例: BTC长持+波动策略")
